...
class BodyLineStripArray extends BodyGeometryStripArray
...

{
    ...
    static {
	loadCapabilities(BodyGeometryArray.class, BodyLineStripArray.class);
	loadCapabilities(capabilities, BodyLineStripArray.class);
	capabilities = null;
    }
    ...
    BodyLineStripArray(J3DObject data) {

	this(null, data);
    }


    BodyLineStripArray(LineStripArray geometryarray) {

	this(geometryarray, (J3DObject)VM.getTypeTemplate(T_LINESTRIPARRAY));
    }


    private
    BodyLineStripArray(LineStripArray geometryarray, J3DObject data) {

	super(geometryarray, data, 2);
	buildLineStripArray(geometryarray);
	setFixedSize();
    ...
    private void
    buildLineStripArray(LineStripArray geometryarray) {

	int  count;

	if ((this.geometryarray = geometryarray) == null) {
	    count = vertexCount();
	    this.geometryarray = new LineStripArray(
		count,
