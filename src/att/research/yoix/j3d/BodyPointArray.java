...
class BodyPointArray extends BodyGeometryArray
...

{
    ...
    static {
	loadCapabilities(BodyGeometryArray.class, BodyPointArray.class);
	loadCapabilities(capabilities, BodyPointArray.class);
	capabilities = null;
    }
    ...
    BodyPointArray(J3DObject data) {

	this(null, data);
    }


    BodyPointArray(PointArray geometryarray) {

	this(geometryarray, (J3DObject)VM.getTypeTemplate(T_POINTARRAY));
    }


    private
    BodyPointArray(PointArray geometryarray, J3DObject data) {

	super(geometryarray, data, 1);
	buildPointArray(geometryarray);
	setFixedSize();
    ...
    private void
    buildPointArray(PointArray geometryarray) {

	if ((this.geometryarray = geometryarray) == null) {
	    this.geometryarray = new PointArray(
		vertexCount(),
