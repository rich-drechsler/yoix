...
class BodyTriangleStripArray extends BodyGeometryStripArray
...

{
    ...
    static {
	loadCapabilities(BodyGeometryArray.class, BodyTriangleStripArray.class);
	loadCapabilities(capabilities, BodyTriangleStripArray.class);
	capabilities = null;
    }
    ...
    BodyTriangleStripArray(J3DObject data) {

	this(null, data);
    }


    BodyTriangleStripArray(TriangleStripArray geometryarray) {
    ...
    private
    BodyTriangleStripArray(TriangleStripArray geometryarray, J3DObject data) {

	super(geometryarray, data, 3);
	buildTriangleStripArray(geometryarray);
	setFixedSize();
    ...
    ///////////////////////////////////
    //
    // BodyTriangleStripArray Methods
    //
    ///////////////////////////////////
    ...
    private void
    buildTriangleStripArray(TriangleStripArray geometryarray) {

	int  count;

	if ((this.geometryarray = geometryarray) == null) {
	    count = vertexCount();
	    this.geometryarray = new TriangleStripArray(
		count,
