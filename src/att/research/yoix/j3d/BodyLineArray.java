...
class BodyLineArray extends BodyGeometryArray
...

{
    ...
    static {
	loadCapabilities(BodyGeometryArray.class, BodyLineArray.class);
	loadCapabilities(capabilities, BodyLineArray.class);
	capabilities = null;
    }
    ...
    BodyLineArray(J3DObject data) {

	this(null, data);
    }


    BodyLineArray(LineArray geometryarray) {

	this(geometryarray, (J3DObject)VM.getTypeTemplate(T_LINEARRAY));
    }


    private
    BodyLineArray(LineArray geometryarray, J3DObject data) {

	super(geometryarray, data, 2);
	buildLineArray(geometryarray);
	setFixedSize();
    ...
    private void
    buildLineArray(LineArray geometryarray) {

	if ((this.geometryarray = geometryarray) == null) {
	    this.geometryarray = new LineArray(
		vertexCount(),
