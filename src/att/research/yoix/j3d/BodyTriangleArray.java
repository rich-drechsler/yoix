...
class BodyTriangleArray extends BodyGeometryArray
...

{
    ...
    static {
	loadCapabilities(BodyGeometryArray.class, BodyTriangleArray.class);
	loadCapabilities(capabilities, BodyTriangleArray.class);
	capabilities = null;
    }
    ...
    BodyTriangleArray(J3DObject data) {

	this(null, data);
    }


    BodyTriangleArray(TriangleArray geometryarray) {

	this(geometryarray, (J3DObject)VM.getTypeTemplate(T_TRIANGLEARRAY));
    }


    private
    BodyTriangleArray(TriangleArray geometryarray, J3DObject data) {

	super(geometryarray, data, 3);
	buildTriangleArray(geometryarray);
	setFixedSize();
    ...
    private void
    buildTriangleArray(TriangleArray geometryarray) {

	if ((this.geometryarray = geometryarray) == null) {
	    this.geometryarray = new TriangleArray(
		vertexCount(),
