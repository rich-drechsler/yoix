...
java -classpath "%YCLASSPATH%" -Xmx1000m -Xms256m -Dyoix.home="%CD%" att.research.yoix.YoixMain -m1.00 -O "%CD%\ychart\scripts\ychart.yx" "%CD%\ychart\data\schedule_ychart.yx"
