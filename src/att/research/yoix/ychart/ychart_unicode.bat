...
java -classpath "%YCLASSPATH%" -Xmx2000m -Xms1000m -Dyoix.home="%CD%" att.research.yoix.YoixMain -m1.00 -O "%CD%\ychart\scripts\ychart.yx" "%CD%\ychart\data\unicode_ychart.yx"
